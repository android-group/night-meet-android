...
public class ApiCallActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(ru.android_studio.night_meet.R.layout.activity_api_call);

		if (getSupportActionBar() != null) getSupportActionBar().setDisplayHomeAsUpEnabled(true);

		if (savedInstanceState == null) {
			getSupportFragmentManager().beginTransaction()
					.add(ru.android_studio.night_meet.R.id.container, new PlaceholderFragment(), FRAGMENT_TAG)
					.commit();
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
			View v = inflater.inflate(ru.android_studio.night_meet.R.layout.fragment_api_call, container, false);
			textView = (TextView) v.findViewById(ru.android_studio.night_meet.R.id.response);
			return v;
		}
	}
}